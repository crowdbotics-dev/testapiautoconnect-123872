...
## Project Structure
    ...
    ├── testapiautoconnect_123872  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_123872`
...
2. Clone this repo and `cd testapiautoconnect_123872`
